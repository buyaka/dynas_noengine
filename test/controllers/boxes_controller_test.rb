...
class BoxesControllerTest < ActionController::TestCase
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post :create, box: { app_id: @box.app_id, name: @box.name, note: @box.note, permissions: @box.permissions }
    end
  ...
  test "should update box" do
    patch :update, id: @box, box: { app_id: @box.app_id, name: @box.name, note: @box.note, permissions: @box.permissions }
    assert_redirected_to box_path(assigns(:box))
  end
